...
if ( ! function_exists( 'beyond_news_edition_start_month' ) ) {
	/**
...
if ( ! function_exists( 'beyond_news_edition_year' ) ) {
	/**
...
if ( ! function_exists( 'beyond_news_year' ) ) {
	/**
...
if ( ! function_exists( 'beyond_news_edition_period' ) ) {
	/**
...
if ( ! function_exists( 'beyond_post_in_news_edition' ) ) {
	/**
...
if ( ! function_exists( 'beyond_news_edition_date_query' ) ) {
	/**
